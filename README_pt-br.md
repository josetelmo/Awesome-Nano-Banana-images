...
Bem-vindo à galeria curada de imagens do **Nano‑banana**! 🤗

**Reunimos imagens e prompts gerados pelo Nano‑banana em diversos cenários de tarefa**, mostrando de forma ampla as possibilidades do Google em geração e edição de imagens. Esperamos que isso ajude você a entender melhor o Nano‑banana. Vamos explorar juntos o potencial de fusão multi‑imagem e de edição criativa do Nano‑banana! ✨

Os casos vêm principalmente do Twitter/X 🐦, Xiaohongshu 📕 e outras plataformas.

Se você curtir, deixe uma ⭐ para acompanhar o repositório!

## 📰 Novidades

- ****Sep-18-2025:** ** Lançamos o **Nano-consistent-150k** dataset.
- ****Sep-16-2025:** ** 4️⃣ Quarta atualização do repositório
- ****Sep-9-2025:** ** 3️⃣ Terceira atualização do repositório
- ****Sep-3-2025:** ** 2️⃣ Segunda atualização do repositório
- ****Aug-28-2025:** ** 🎉 1️⃣ ${\color{red} Primeira\ Awesome-Nano-Banana-images \ atualização!}$
...
- [📑 Menu](#-menu)
- [🖼️ Casos](#️-cases)
  - [Caso 1: Illustration to Figure（by @ZHO\_ZHO\_ZHO）](#case-1-illustration-to-figureby-zho_zho_zho)
  - [Caso 2: Generate Ground View from Map Arrow（by @tokumin）](#case-2-generate-ground-view-from-map-arrowby-tokumin)
  - [Caso 3: Real World AR Information（by @bilawalsidhu）](#case-3-real-world-ar-informationby-bilawalsidhu)
  - [Caso 4: Extract 3D Buildings/Make Isometric Models（by @Zieeett）](#case-4-extract-3d-buildingsmake-isometric-modelsby-zieeett)
  - [Caso 5: Photos of Yourself in Different Eras（by @AmirMushich）](#case-5-photos-of-yourself-in-different-erasby-amirmushich)
  - [Caso 6: Multi-Reference Image Generation（by @MrDavids1）](#case-6-multi-reference-image-generationby-mrdavids1)
  - [Caso 7: Automatic Photo Editing（by @op7418）](#case-7-automatic-photo-editingby-op7418)
  - [Caso 8: Hand Drawing Controls Multi-Character Poses（by @op7418）](#case-8-hand-drawing-controls-multi-character-posesby-op7418)
  - [Caso 9: Cross-View Image Generation（by @op7418）](#case-9-cross-view-image-generationby-op7418)
  - [Caso 10: Custom Character Stickers（by @op7418）](#case-10-custom-character-stickersby-op7418)
  - [Caso 11: Anime to Real Coser（by @ZHO\_ZHO\_ZHO）](#case-11-anime-to-real-coserby-zho_zho_zho)
  - [Caso 12: Generate Character Design（by @ZHO\_ZHO\_ZHO）](#case-12-generate-character-designby-zho_zho_zho)
  - [Caso 13: Color Line Art with Color Palette（by @ZHO\_ZHO\_ZHO）](#case-13-color-line-art-with-color-paletteby-zho_zho_zho)
  - [Caso 14: Article Infographic（by @黄建同学）](#case-14-article-infographicby-黄建同学)
  - [Caso 15: Change Multiple Hairstyles（by @balconychy）](#case-15-change-multiple-hairstylesby-balconychy)
  - [Caso 16: Model Annotation Explanation Diagram（by @berryxia\_ai）](#case-16-model-annotation-explanation-diagramby-berryxia_ai)
  - [Caso 17: Custom Marble Sculpture（by @umesh\_ai）](#case-17-custom-marble-sculptureby-umesh_ai)
  - [Caso 18: Cook Based on Ingredients（by @Gdgtify）](#case-18-cook-based-on-ingredientsby-gdgtify)
  - [Caso 19: Math Problem Reasoning（by @Gorden Sun）](#case-19-math-problem-reasoningby-gorden-sun)
  - [Caso 20: Old Photo Colorization（by @GeminiApp）](#case-20-old-photo-colorizationby-geminiapp)
  - [Caso 21: OOTD Outfit（by @302.AI）](#case-21-ootd-outfitby-302ai)
  - [Caso 22: Character Clothing Change（by @skirano）](#case-22-character-clothing-changeby-skirano)
  - [Caso 23: Multi-View Result Generation（by @Error\_HTTP\_404）](#case-23-multi-view-result-generationby-error_http_404)
  - [Caso 24: Movie Storyboard（by @GeminiApp）](#case-24-movie-storyboardby-geminiapp)
  - [Caso 25: Character Pose Modification（by @arrakis\_ai）](#case-25-character-pose-modificationby-arrakis_ai)
  - [Caso 26: Generate image from line drawing（by @ZHO\_ZHO\_ZHO）](#case-26-generate-image-from-line-drawingby-zho_zho_zho)
  - [Caso 27: Add Watermark to Image（by @AiMachete）](#case-27-add-watermark-to-imageby-aimachete)
  - [Caso 28: Knowledge Reasoning Image Generation（by @icreatelife）](#case-28-knowledge-reasoning-image-generationby-icreatelife)
  - [Caso 29: Red Pen Annotations（by @AiMachete）](#case-29-red-pen-annotationsby-aimachete)
  - [Caso 30: Explosive Food（by @icreatelife）](#case-30-explosive-foodby-icreatelife)
  - [Caso 31: Create Comic Book（by @icreatelife）](#case-31-create-comic-bookby-icreatelife)
  - [Caso 32: Action Figure（by @icreatelife）](#case-32-action-figureby-icreatelife)
  - [Caso 33: Map to Isometric Buildings（by @demishassabis）](#case-33-map-to-isometric-buildingsby-demishassabis)
  - [Caso 34: Reference Image Controls Character Expression（by @ZHO\_ZHO\_ZHO）](#case-34-reference-image-controls-character-expressionby-zho_zho_zho)
  - [Caso 35: Illustration Drawing Process Four-Panel（by @ZHO\_ZHO\_ZHO）](#case-35-illustration-drawing-process-four-panelby-zho_zho_zho)
  - [Caso 36: Virtual Makeup Try-On（by @ZHO\_ZHO\_ZHO）](#case-36-virtual-makeup-try-onby-zho_zho_zho)
  - [Caso 37: Makeup Analysis（by @ZHO\_ZHO\_ZHO）](#case-37-makeup-analysisby-zho_zho_zho)
  - [Caso 38: Google Maps View of Middle-earth（by @TechHallo）](#case-38-google-maps-view-of-middle-earthby-techhallo)
  - [Caso 39: Typographic Illustration Generation（by @Umesh）](#case-39-typographic-illustration-generationby-umesh)
  - [Caso 40: Multiple Character Poses Generation（by @tapehead\_Lab）](#case-40-multiple-character-poses-generationby-tapehead_lab)
  - [Caso 41: Product Packaging Generation（by @ZHO\_ZHO\_ZHO）](#case-41-product-packaging-generationby-zho_zho_zho)
  - [Caso 42: Overlay Filter/Material（by @ZHO\_ZHO\_ZHO）](#case-42-overlay-filtermaterialby-zho_zho_zho)
  - [Caso 43: Control Character Face Shape（by @ZHO\_ZHO\_ZHO）](#case-43-control-character-face-shapeby-zho_zho_zho)
  - [Caso 44: Lighting Control（by @ZHO\_ZHO\_ZHO）](#case-44-lighting-controlby-zho_zho_zho)
  - [Caso 45: LEGO Minifigure（by @ZHO\_ZHO\_ZHO）](#case-45-lego-minifigureby-zho_zho_zho)
  - [Caso 46: Gundam Model Figure（by @ZHO\_ZHO\_ZHO）](#case-46-gundam-model-figureby-zho_zho_zho)
  - [Caso 47: Hardware Exploded View（by @AIimagined）](#case-47-hardware-exploded-viewby-aiimagined)
  - [Caso 48: Food Calorie Annotation（by @icreatelife）](#case-48-food-calorie-annotationby-icreatelife)
  - [Caso 49: Extract Subject and Place on Transparent Layer（by @nglprz）](#case-49-extract-subject-and-place-on-transparent-layerby-nglprz)
  - [Caso 50: Image Outpainting Repair（by @bwabbage）](#case-50-image-outpainting-repairby-bwabbage)
  - [Caso 51: Ancient Map → Historical Scene Photo（by @levelsio）](#case-51-ancient-map--historical-scene-photoby-levelsio)
  - [Caso 52: Fashion Moodboard Collage（by @tetumemo）](#case-52-fashion-moodboard-collageby-tetumemo)
  - [Caso 53: Delicate Cute Product Photo（by @azed\_ai）](#case-53-delicate-cute-product-photoby-azed_ai)
  - [Caso 54: Place Anime Statue in Real Life（by @riddi0908）](#case-54-place-anime-statue-in-real-lifeby-riddi0908)
  - [Caso 55: Create an Itasha Car（by @riddi0908）](#case-55-create-an-itasha-carby-riddi0908)
  - [Caso 56: Manga Composition（by @namaedousiyoka）](#case-56-manga-compositionby-namaedousiyoka)
  - [Caso 57: Manga Style Conversion（by @nobisiro\_2023）](#case-57-manga-style-conversionby-nobisiro_2023)
  - [Caso 58: Isometric Holographic Wireframe（by @tetumemo）](#case-58-isometric-holographic-wireframeby-tetumemo)
  - [Caso 59: Minecraft-Style Scene Generation（by @tetumemo）](#case-59-minecraft-style-scene-generationby-tetumemo)
  - [Caso 60: Apply Material Sphere to Logo（by @ZHO\_ZHO\_ZHO）](#case-60-apply-material-sphere-to-logoby-zho_zho_zho)
  - [Caso 61: Floor Plan 3D Render（by @op7418）](#case-61-floor-plan-3d-renderby-op7418)
  - [Caso 62: Reset Camera Parameters（by @hckinz）](#case-62-reset-camera-parametersby-hckinz)
  - [Caso 63: Create an ID Photo（by @songguoxiansen）](#case-63-create-an-id-photoby-songguoxiansen)
  - [Caso 64: Scene A6 Folding Card（by @Gdgtify）](#case-64-scene-a6-folding-cardby-gdgtify)
  - [Caso 65: Design a Chess Set（by @Gdgtify）](#case-65-design-a-chess-setby-gdgtify)
  - [Caso 66: Split-Contrast Style Photo（by @fofrAI）](#case-66-split-contrast-style-photoby-fofrai)
  - [Caso 67: Jewelry Collection Design（by @Gdgtify）](#case-67-jewelry-collection-designby-gdgtify)
  - [Caso 68: Merchandise Design（by @0xFramer）](#case-68-merchandise-designby-0xframer)
...
> [!NOTA]
> **Altere o texto entre [colchetes] para your era and detail information**
...
> [!NOTA]
> **Altere o texto entre [colchetes] para the model you want to showcase**
...
```
> [!NOTA]
> **Altere o texto entre [colchetes] para the items you want to add**
...
### Caso 34: [Reference Image Controls Character Expression](https://x.com/ZHO_ZHO_ZHO/status/1963156830458085674)（by [@ZHO_ZHO_ZHO](https://x.com/ZHO_ZHO_ZHO)）
...
### Caso 35: [Illustration Drawing Process Four-Panel](https://x.com/ZHO_ZHO_ZHO/status/1961772524611768452)（by [@ZHO_ZHO_ZHO](https://x.com/ZHO_ZHO_ZHO)）
...
### Caso 36: [Virtual Makeup Try-On](https://x.com/ZHO_ZHO_ZHO/status/1962778069242126824)（by [@ZHO_ZHO_ZHO](https://x.com/ZHO_ZHO_ZHO)）
...
> [!NOTA]
> **Altere o texto entre [colchetes] para the desired location and weather**
...
> [!NOTA]
> **Altere o texto entre [colchetes] para the desired text**

<!-- Case 40: Multiple Character Poses Generation (by @tapehead_Lab) -->
### Caso 40: [Multiple Character Poses Generation](https://x.com/tapehead_Lab/status/1960878455299694639)（by [@tapehead_Lab](https://x.com/tapehead_Lab)）
...
### Caso 41: [Product Packaging Generation](https://x.com/ZHO_ZHO_ZHO/status/1962763864875167971)（by [@ZHO_ZHO_ZHO](https://x.com/ZHO_ZHO_ZHO)）
...
### Caso 42: [Overlay Filter/Material](https://x.com/ZHO_ZHO_ZHO/status/1962520937011855793)（by [@ZHO_ZHO_ZHO](https://x.com/ZHO_ZHO_ZHO)）
...
> [!NOTA]
> **Altere o texto entre [colchetes] para the desired filter/material**

<!-- Case 43: Control Character Face Shape (by @ZHO_ZHO_ZHO) -->
### Caso 43: [Control Character Face Shape](https://x.com/ZHO_ZHO_ZHO/status/1961802767493939632)（by [@ZHO_ZHO_ZHO](https://x.com/ZHO_ZHO_ZHO)）
...
### Caso 44: [Lighting Control](https://x.com/ZHO_ZHO_ZHO/status/1961779457372602725)（by [@ZHO_ZHO_ZHO](https://x.com/ZHO_ZHO_ZHO)）
...
### Caso 60: [Apply Material Sphere to Logo](https://x.com/ZHO_ZHO_ZHO/status/1964995347505352794)（by [@ZHO_ZHO_ZHO](https://x.com/ZHO_ZHO_ZHO)）
...
### Caso 65: [Design a Chess Set](https://x.com/Gdgtify/status/1964679042994442454)（by [@Gdgtify](https://x.com/Gdgtify)）
...
### Caso 66: [Split-Contrast Style Photo](https://x.com/fofrAI/status/1964818395381248397)（by [@fofrAI](https://x.com/fofrAI)）
...
## 🖼️ Casos 91 em diante e Seções Finais
